...
if __name__ == "__main__":
    ...
    parser.add_argument('--drone',              default=['robobee'],  type=list,    help='Drone model (default: CF2X)', metavar='', choices=[DroneModel])
